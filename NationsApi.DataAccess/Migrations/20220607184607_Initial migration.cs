        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalDay = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryFlags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CountryFlags_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryStats", x => new { x.Year, x.CountryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryFlags_CountryId",
                table: "CountryFlags",
                column: "CountryId");
